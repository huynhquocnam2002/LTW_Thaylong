...
">
    ...
    <!-- Custom StyleSheet -->
    <link rel="stylesheet" href="phone_nam/styles.css"/>
    ...
    <div class="navigation">
        <div class="container">
            <nav class="nav">
                ...
                %>
                <div class="nav__icons">
                    <a href="/phone_thuan/user.html" style="padding: 0; height: 4rem; width: 4rem" class="icon__item">
                        <img src="<%=user.getImg()%>"
                    ...
                    <div class="nav__item_user" style="font-size: 1.2rem" id="nav__item_user1">
                        <a href="phone_thuan/user.html" class="nav__link scroll-link"
...
<script src="phone_nam/js/slider.js"></script>
