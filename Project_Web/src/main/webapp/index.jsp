            ...
            <ul class="nav__list" id="nav__list_DANHMUC">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                    <img class="icon__itemdanhmuc" src="icon\oplung.png"></img>
                </a>
              <li class="nav__item">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                  <img class="icon__itemdanhmuc" src="icon\sacduphong.jpg"></img>
                </a>
              <li class="nav__item">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                  <img class="icon__itemdanhmuc" src="icon\tainghe.png"></img>
                </a>
              <li class="nav__item">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                  <img class="icon__itemdanhmuc" src="icon\capsac.png"></img>
                </a>
              <li class="nav__item">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                  <img class="icon__itemdanhmuc" src="icon\kinhcuongluc.jpg"></img>
                </a>
              <li class="nav__item">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                  <img class="icon__itemdanhmuc" src="icon\apple1.png"></img>
                </a>
              <li class="nav__item">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                  <img class="icon__itemdanhmuc" src="icon\gaydienthoai.png"></img>
                </a>
              <li class="nav__item">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                  <img class="icon__itemdanhmuc" src="icon\bag1.png"></img>
                </a>
              <li class="nav__item">
              ...
              <div class="nav__icons_danhmuc">
                <a href="/phone_nam/indexseach.html" class="icon__item">
                  <img class="icon__itemdanhmuc" src="icon\khac.jpg"></img>
                </a>
              <li class="nav__item">
          ...
          <ul class="glide__slides">
            <li class="glide__slide">
              <div class="hero__center">
                <div class="hero__left">
                  ...
                  <a href="/phone_chuong/product.html"><button class="hero__btn">MUA NGAY</button></a>
                </div>
                <div class="hero__right">
                  <div class="hero__img-container">
                    <img class="banner_01" src="./images/sacduphong1.png" alt="banner2" />
                  </div>
                </div>
              </div>
            </li>
            <li class="glide__slide">
              <div class="hero__center">
                ...
                <div class="hero__right">
                  <img class="banner_02" src="./images/tainghe6.png" alt="banner2" />
                </div>
              </div>
            </li>
          </ul>
    ...
    <div class="container">
      ...
      <section id="collection" class="section collection">
        <div class="collection__container" data-aos="fade-up" data-aos-duration="1200">
          ...
          <div class="collection__box">
            <div class="img__container">
              <img class="collection_01" src="./images/sacnhanh1.png" alt="">
            </div>
            <div class="collection__content">
              <div class="collection__data">
      ...
      <section class="section section-danhmuc">
          ...
          <div>
            ...
            <ul class="nav__list" id="nav__list_DANHMUC1">
              ...
              <li class="nav__item">
                <a href="/phone_nam/indexseach.html" class="scroll-linkDANHMUC">CÁP CHUYỂN ĐỔI</a>
              </li>
            </div>
              ...
              <li class="nav__item">
                <a href="/phone_nam/indexseach.html" class="scroll-linkDANHMUC">MIC PHỤ</a>
              </li>
            </div>
              ...
              <li class="nav__item">
                <a href="/phone_nam/indexseach.html" class="scroll-linkDANHMUC">ĐÈN MINI</a>
              </li>
            </div>
              ...
              <li class="nav__item">
                <a href="/phone_nam/indexseach.html" class="scroll-linkDANHMUC">KHĂN LAU MÀN HÌNH</a>
              </li>
            </div>
              ...
              <li class="nav__item">
                <a href="/phone_nam/indexseach.html" class="scroll-linkDANHMUC">DỤNG CỤ VỆ SINH</a>
              </li>
            </div>
              ...
              <li class="nav__item">
                <a href="/phone_nam/indexseach.html" class="scroll-linkDANHMUC">BÚT CẢM ỨNG</a>
              </li>
            </div>
            ...
            <div class="glide__track" data-glide-el="track">
              <ul class="glide__slides latest-center">
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/gay1.jpg" alt="product">
                    </div>
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/taingh6.webp" alt="product">
                    </div>
                    <div class="product__footer">
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/sacdp1.jpg" alt="product">
                    </div>
                    <div class="product__footer">
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/gay2.jpg" alt="product">
                    </div>
                    <div class="product__footer">
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/op1.webp" alt="product">
                    </div>
                    <div class="product__footer">
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/cuongluc1.jpg" alt="product">
                    </div>
                    <div class="product__footer">
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/tainghe5.jpg" alt="product">
                    </div>
                    <div class="product__footer">
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/sacdp3.jpg" alt="product">
                    </div>
                    <div class="product__footer">
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="./images_phukien/op3.png" alt="product">
                    </div>
                    <div class="product__footer">
              ...
              <li class="glide__slide">
                <div class="testimonial__box">
                  <div class="client__image">
                    <img src="./img/voucher2.png" alt="profile">
                  </div>
                  ...
                  <div class="new__card">
                    ...
                    <div class="card__footer">
                      ...
                      <p>Sự nhiệt tình và quy cách phục vụ chuyên nghiệp tại
                        JC PHONE khiến ca nghệ sĩ rất hài lòng. Các nghệ sĩ nổi tiếng cho biết rất là an tâm hơn,...</p>
    ...
    <div class="container">
      <div class="footer__top">
        ...
        <div class="footer-top__box">
          ...
          <a href="/phone_nam/login.css">Tài khoản của tôi</a>
          <a href="/phone_nam/login.css">Lịch sử đơn hàng</a>
          <a href="/phone_nam/login.css">Danh sách mong muốn</a>
          <a href="#">Cung cấp thông tin</a>
          <a href="/phone_nam/index.html">Quay lại</a>
        </div>  
        <div class="footer-top__box">
          <h3>CONTACT US</h3>
          <div>
    ...
    <div class="popup__content">
      ...
      <div class="popup__right">
        <div class="right__content">
          ...
          <p>Đăng ký nhận bản tin của JC-Team và tiết kiệm 30% cho lần mua hàng tiếp theo. Không có thư rác, Hứa luôn á,
