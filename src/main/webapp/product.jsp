...
<section id="section-detailsProduct">
  ...
  <div class="section__container__product">
    ...
    <div class="product-detail__left">
                  ...
                  <div class="hero__center">
                    <div class="hero__left">
                      ...
                      <div class="desktop">
                        ...
                        Chế độ sạc nhỏ giọt Trickle-Charging cho các thiết bị cần <br> dòng sạc thấp
                  ...
                  <div class="hero__center">
                    <div class="hero__left">
                      ...
                      <img src="
                           ...
                           alt="img__product" class="image__detail__product" style="width:375px!important;height: 375px !important; position: relative;top:-22px;padding: 10px;border-radius: 10px;">
      ...
      <img style="position: absolute; bottom: -50px; "src="https://cdn2.cellphones.com.vn/x/https://dashboard.cellphones.com.vn/storage/teasing-Camp-100-product.gif" alt="">
    </div>

    <div class="product-detail__center">


      <h3 style="color: red; " >900.000đ  <p style="color:#707070; position: relative; left:90px; bottom:25px;"><del>1.000.000 </del><u>đ</u> </p></h3>
      ...
      <div class="title">
        ...
        <div class="product__bonus">
          ...
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQu_Db-7oZT6WVbPR9ouktyhihrr-PCyf0lle3zrMQ_dEpQpp5UfVbwNflLldcQ-H5-fGs&usqp=CAU" alt="" style ="width:25px;height:25px;position:absolute; top: -15px; left: 35px;z-index: 9;">  <span style="color: #be1e2d;text-align:center; width: 115px; background-color:white;position:absolute; top: -15px; left: 60px;">Khuyến mãi</span>
...
<div class="product-detail__bottom">
  ...
  <div class="detail__content">
    <div class="content active" id="description">
      ...
      <ul>
        <li>Các sản phẩm pin sạc dự phòng Anker luôn là lựa chọn hàng đầu của nhiều người dùng về chất lượng cũng như kiểu dáng.</li>
        <li><span style="color:#D70018;font-weight: 200;" >Pin sạc dự phòng </span>Anker PowerSlim 10000mAh PD A1244 với kiểu dáng mỏng nhẹ số 1 thế giới, hỗ trợ sạc 3 chế độ,…</li>
        <li>chính là một phụ kiện vô cùng hợp lý.</li>

      </ul>
      <h2>Kiểu dáng mỏng nhẹ hàng đầu với nguồn sức mạnh to lớn 10000mAh</h2>
      <p>Pin sạc dự phòng Anker PowerSlim 10000mAh PD A1244 có kiểu dáng giống với tên gọi “PowerSlim” của mình – mỏng nhẹ

        <span id="dots">...</span> </p>

      <img style="width:100% ;height: 495.23px; object-fit: cover; "src="https://cdn2.cellphones.com.vn/358x/media/catalog/product/p/i/pin-sac-du-phong-anker-powercore-iii-sense-slim-a1244-10000mah.jpg" alt="">

      <p>Hỗ trợ 3 chế độ sạc và công nghệ PD tiết kiệm thời gian sạc
        Pin sạc dự phòng Anker PowerSlim 10000mAh PD A1244 cung cấp <br> cho người dùng 3 chế độ sạc bao gồm sạc nhanh 20W USB-C,sạc 12W USB-A cùng công nghệ PowerIQ, cuối cùng là sạc nhỏ giọt<br>  Trickle-Charging phù hợp với những thiết bị có dòng sạc thấp.</p>
      <!--
      ...
      <div class="container__feedback">
        ...
        <div class="container__feedback__name">
          ...
          <div class="container__name__image" style="display: flex;align-items: center; ">
            <img class="container__feedback__name--border" src="https://scontent.fsgn2-7.fna.fbcdn.net/v/t39.30808-6/275669743_1361047297676932_7075608344792939540_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=ZukN44NzPN8AX_GRqp7&_nc_ht=scontent.fsgn2-7.fna&oh=00_AfDcKItUUdwzHqXeolj5A82eR-7VqSx39gu9Em3Ea-qBhw&oe=636D10D1" alt="">
        ...
        <div class="container__feedback__name">
          ...
          <div class="container__name__image" style="display: flex;align-items: center; ">
            <img class="container__feedback__name--border" src="https://scontent.fsgn2-4.fna.fbcdn.net/v/t39.30808-6/269683013_1294293907710187_3077575652464397202_n.jpg?stp=dst-jpg_p526x296&_nc_cat=109&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=BC-puduVYdwAX-aJjgi&_nc_ht=scontent.fsgn2-4.fna&oh=00_AfDM5VW0F2POTVCNZJ_UKYaAh3jXSIFd75gIz9VZ_hK5OA&oe=636E57AA" alt="">
        ...
        <div class="container__feedback__name">
          ...
          <div class="container__name__image" style="display: flex;align-items: center; ">
            <img class="container__feedback__name--border" src="https://scontent.fsgn2-4.fna.fbcdn.net/v/t39.30808-6/275662930_1342361109613177_1798580031594503466_n.jpg?stp=dst-jpg_s552x414&_nc_cat=109&ccb=1-7&_nc_sid=e3f864&_nc_ohc=Ms-d2SFfY58AX8Ybql3&_nc_ht=scontent.fsgn2-4.fna&oh=00_AfCr1ieXg1QCtmAKdct-LOuuuVafKBLj-bDjQBYW04OzTQ&oe=636D1B63" alt="">
        ...
        <div class="container__feedback__name">
          ...
          <div class="container__name__image" style="display: flex;align-items: center; ">
            <img class="container__feedback__name--border" src="https://scontent.fsgn2-6.fna.fbcdn.net/v/t39.30808-6/299940262_1718876608449064_4338647799853200977_n.jpg?stp=dst-jpg_s720x720&_nc_cat=111&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=9uDCpFJY1S4AX8zYZj6&_nc_ht=scontent.fsgn2-6.fna&oh=00_AfDmR2si5XOzZbcFpY9EzLkhJI0igo963HBJFfOVJtFAMA&oe=636EC7A4" alt="">
...
<section class="section related__products">
  ...
  <div class="container" data-aos="fade-up" data-aos-duration="1200">
    <div class="glide" id="glide_3">
      <div class="glide__track" data-glide-el="track">
        <ul class="glide__slides latest-center">
          <li class="glide__slide">
            <div class="product">
              <div class="product__header">
                <a href="#"><img src="https://cdn.didongviet.vn/pub/media/catalog/product//s/a/sac-du-phong-mazer-infinite-boost-supermini-pocket-8.0-v2-8000mah-didongviet.jpg" alt="product"></a>
              </div>
          ...
          <li class="glide__slide">
            <div class="product">
              <div class="product__header">
                <a href="#"><img src="https://cdn.didongviet.vn/pub/media/catalog/product//p/i/pin-sac-du-phong-mophie-snap_-powerstation-stand-10000-mah-didongviet_1.jpg" alt="product"></a>
              </div>
              <div class="product__footer">
                <h3>
          ...
          <li class="glide__slide">
            <div class="product">
              <div class="product__header">
                <a href="#"><img src="https://cdn.didongviet.vn/pub/media/catalog/product//p/i/pin-sac-du-phong-aukey-basix-slim-pd-n99-10000mah-didongviet.jpg" alt="product"></a>
              </div>
              <div class="product__footer">
          ...
          <li class="glide__slide">
            <div class="product">
              <div class="product__header">
                <a href="#"><img src="https://cdn.didongviet.vn/pub/media/catalog/product//p/i/pin-sac-du-phong-aukey-10000mah-pb-n83s-didongviet.jpg" alt="product"></a>
              </div>
              <div class="product__footer">
                <h3>Pin sạc dự phòng Aukey </h3>
                <div class="rating">
      ...
      <div class="glide__arrows" data-glide-el="controls">
        <button style="position: absolute; left:0; top:50%;"class="glide__arrow glide__arrow--left" data-glide-dir="<">
          <svg>
            <use xlink:href="./images/sprite.svg#icon-arrow-left2"></use>
          </svg>
        </button>
        <button style="position: absolute; left:96%; top:50%;"class="glide__arrow glide__arrow--right" data-glide-dir=">">
          <svg>
            <use xlink:href="./images/sprite.svg#icon-arrow-right2"></use>
          </svg>
        </button>
