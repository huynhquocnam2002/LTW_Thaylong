...
<%@ page import="vn.edu.hcmuaf.fit.model.Nhanhieu" %>
...
<!--Nhãn Hiệu-->
<% List<Nhanhieu> nhanhieuList = FooterDAO.getNhanhieu();%>
<section class="section nhanhieu">
  <div class="container">
    <div class="content">
      <h1 class="content-title"> VÌ SAO CHÚNG TÔI LẠI CÓ TÊN NHÃN HIỆU LÀ JC SHOP ?</h1>
      <% for (int i = 0; i < nhanhieuList.size(); i++) { %>


      <h2><%= nhanhieuList.get(i).getText()%>:</h2>
      <P><%= nhanhieuList.get(i).getText1()%> :</P>
      <P>– <%= nhanhieuList.get(i).getText2()%></P>
      <P>– <%= nhanhieuList.get(i).getText3()%></P>
      <P>– <%= nhanhieuList.get(i).getText4()%></P>
      <P>– <%= nhanhieuList.get(i).getText5()%></P>
      <P>– <%= nhanhieuList.get(i).getText()%></P>
      <img class="image_nhanhieu" src="<%= nhanhieuList.get(i).getTitle()%>" alt="" style="background-color: #BE1E2D;">
