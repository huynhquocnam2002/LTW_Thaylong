            ...
            <div class="table-row-div table-row-div-product">
                ...
                <table class="manage-products-table">
                    <tr class="row-table row-table-main product-row">
                        ...
                        <td class="proceed">
                            <div class="proceed-div">
                                <a href="/ModifyProductServlet?id=<%=p.getId()%>"><p class="edit-proceed">Chỉnh sửa</p></a>
                                <a href="/StopSellProductServlet?id=<%=p.getId()%>" style="text-decoration: none"><p class="delete-proceed">Ngừng bán</p></a>
                                <a href="/AddOptionServlet?id=<%=p.getId()%>"><p class="delete-proceed">Thêm option</p></a>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr class="row-table row-table-child product-row">
                        ...
                        <td class="proceed">
                            <div class="proceed-div">
                                <a href="/InfoOptionServlet?id=<%=op.getId()%>"><p>Chỉnh sửa</p></a>
                            </div>
                        </td>
                    </tr>
                    <%}%>
                ...
                <tr class="table-row">
                    ...
                    <td class="input-col">
                        <select name="tag" id="new-product-tag" class="input-field">
                            ...
                            <option value="salerun">Bán chạy</option>
