//load product
function isSelected(status, num) {
    if (parseInt(status)==num) return 'selected'
}
...
//all product
const all_products = document.querySelector("#admin-content #rightContainer .manage-products .table-row-div-product");
...
const displayProductItems = items => {
        ...
        product => ` 
            <table class="manage-products-table">
                  <tr class="row-table row-table-main product-row">
                                        ...
                                        <div class="product-name-container">
                                            ...
                                            <div class="container-info">
                                                <div class="name-block">
                                                    <textarea name="product-name" rows="2" class="product-name editable" rows="1"
                                                              disabled>${product.name}</textarea>
                                                    <i class="edit-button fa-solid fa-pen-clip"></i>
                                                    <i class="ok-button fa-solid fa-check"></i>
                                                </div>
                                                <div class="id-block">
                                                    <p class="product-id">ID: <span class="id-span">${product.id}</span></p>
                                    ...
                                    <td class="product-quantity-col">
                                        <div class="quantity-block">
                                            <input type="text" pattern="^\\d+$" value="${product.quantity}" name="product-quantity"
                                    ...
                                    <td class="uint-price-col">
                                        <div class="unit-price-block">
                                            <input type="text" value="${product.price}" pattern="^\\d+$" name="product-unit-price"
                                    ...
                                    <td class="product-status-col">
                                        <div class="product-status-div">
                                            ...
                                            <select name="product-status" value="${product.status}" class="product-status editable">
                                                <option class="delete-option" value="-1" ${isSelected(product.status,-1)}>Đã xóa</option>
                                                <option class="upcoming-option" value="0" ${isSelected(product.status,0)}>Sắp mở bán</option>
                                                <option class="selling-option" value="1" ${isSelected(product.status,1)}>Đang bán</option>
                                                <option class="stop-selling-option" value="2" ${isSelected(product.status,2)}>Dừng kinh doanh</option>
                                            </select>
                                        </div>
                                    </td>
                                    <td class="proceed">
                  ...
                  <tr class="row-table row-table-child product-row">
                                    ...
                                    <td class="product-type-col">
                                        <div class="product-type-div">
                                            <input type="text" name="product-type" value="Đen"
                                    ...
                                    <td class="product-quantity-col">
                                        <div class="quantity-block">
                                            <input type="text" pattern="^\\d+$" value="${Math.floor(product.quantity / 2)}" name="product-quantity"
                                                   class="product-quantity editable" disabled>
                                            <i class="edit-button fa-solid fa-pen-clip"></i>
                                            <i class="ok-button fa-solid fa-check"></i>
                                        </div>
                                    ...
                                    <td class="uint-price-col">
                                        <div class="unit-price-block">
                                            <input type="text" value="${product.price}" pattern="[0-9]" name="product-unit-price"
                                                   class="product-unit-price editable" disabled><span><u>đ</u></span>
                                            <i class="edit-button fa-solid fa-pen-clip"></i>
                                            <i class="ok-button fa-solid fa-check"></i>
                                        </div>
                  ...
                  <tr class="row-table row-table-child product-row">
                                    ...
                                    <td class="product-type-col">
                                        <div class="product-type-div">
                                            <input type="text" name="product-type" value="Trắng"
                                                   class="product-type editable" disabled>
                                            <i class="edit-button fa-solid fa-pen-clip"></i>
                                            <i class="ok-button fa-solid fa-check"></i>
                                        </div>
    ...
    if (all_products) {
        all_products.innerHTML = displayProduct;
    }
};
//selling product
const selling_products = document.querySelectorAll("#admin-content #rightContainer .manage-products .table-row-div-product")[1];

window.addEventListener("DOMContentLoaded", async function () {
    const products = await getProducts();
    displaySellingProductItems(products);
    run()
});
const displaySellingProductItems = items => {

    let displayProduct = items.map(
        product => {if (product.status=='1') return ` 
            <table class="manage-products-table">
                  <tr class="row-table row-table-main product-row">
                                    <td>
                                        <div class="id-check-product-div">
    ...
    displayProduct = displayProduct.join("");
    if (selling_products) {
        selling_products.innerHTML = displayProduct;
    }
};

//upcoming product
const upcoming_products = document.querySelectorAll("#admin-content #rightContainer .manage-products .table-row-div-product")[2];

window.addEventListener("DOMContentLoaded", async function () {
    const products = await getProducts();
    displayUpcomingProductItems(products);
    run()
});
const displayUpcomingProductItems = items => {

    let displayProduct = items.map(
        product => {if (product.status=='0') return ` 
            <table class="manage-products-table">
                  <tr class="row-table row-table-main product-row">
                                    <td>
                                        <div class="id-check-product-div">
    ...
    if (upcoming_products) {
        upcoming_products.innerHTML = displayProduct;
    }
};

//stop sell product
const stop_products = document.querySelectorAll("#admin-content #rightContainer .manage-products .table-row-div-product")[3];

window.addEventListener("DOMContentLoaded", async function () {
    const products = await getProducts();
    displayStopProductItems(products);
    run()
});
const displayStopProductItems = items => {

    let displayProduct = items.map(
        product => {if (product.status=='2') return ` 
            <table class="manage-products-table">
                  <tr class="row-table row-table-main product-row">
                                    <td>
                                        <div class="id-check-product-div">
    ...
    displayProduct = displayProduct.join("");
    if (stop_products) {
        stop_products.innerHTML = displayProduct;
    }
};

//delete product
const delete_products = document.querySelectorAll("#admin-content #rightContainer .manage-products .table-row-div-product")[4];

window.addEventListener("DOMContentLoaded", async function () {
    const products = await getProducts();
    displayDeleteProductItems(products);
    run()
});
const displayDeleteProductItems = items => {
    ...
    displayProduct = displayProduct.join("");
    if (delete_products) {
        delete_products.innerHTML = displayProduct;
    }
};
