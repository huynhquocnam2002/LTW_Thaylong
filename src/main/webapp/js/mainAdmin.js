...
const categoryCenter = document.querySelector("#admin-content #rightContainer .manage-products .table-row-div-product");
                                    ...
                                    <td class="product-status-col">
                                        <div class="product-status-div">
                                            ...
                                            <select name="product-status" value="${product.status}" class="product-status editable">
                                                ...
                                                <option class="selling-option" value="1">Đang bán</option>
...
function run() {
    ...
    for (let i of list_product) {
        let status = i.querySelectorAll('p')
        let select = i.querySelector('.product-status').value
        for (let j of status) {
