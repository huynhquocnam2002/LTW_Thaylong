                  ...
                  <div class="product category__products">
                    ...
                    <div class="product__footer">
                      ...
                      <div class="product__price">
                        ...
                        <h4>`+numberWithCommas(product.price*22000)+ `VNĐ</h4>
                      </div>
...
if (categoryContainer) {
  categoryContainer.addEventListener("click", async e => {
    ...
    // let productssort = products.sort(compareValues('price', 'desc'));
    if(id === "All Products sort desc"){
      displayProductItems(products.sort((a, b) => a.price - b.price));
    }
    if(id === "All Products sort est"){
      displayProductItems(products.sort((a, b) => b.price - a.price));
    }
  });
}
