...
<%@ page import="vn.edu.hcmuaf.fit.model.Forus" %>
...
<!--Nhãn Hiệu-->
    <% List<Forus> listfc = FooterDAO.getForus(); %>
<section class="section vechungtoi">
  <div class="container">
    <div class="content">
      <!-- <h1 class="content-title">JC SHOP</h1> -->
      <img class="image_nhanhieu" src="/jcphone.png" alt="" style="background-color: #BE1E2D;">
        <P class="content-title" >NHÀ SÁNG LẬP JCSHOP</P>
      <%
        for (int i = 0; i < listfc.size() -1; i++) { %>


        <div class="content-profile">
          <img class="image-avt" src="<%=listfc.get(i).getImage()%>" alt="">
          <h1><%=listfc.get(i).getName()%></h1>
          <h3><%=listfc.get(i).getPosition()%></h3>
          <p><%=listfc.get(i).getDescribe()%></p>
        </div>
