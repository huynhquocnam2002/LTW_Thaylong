    ...
    <div class="container">
        <div class="contentDiv">
            <div class="leftContent">
                <div class="account">
                    <img src="../phone_thuan/images/avatar.jpg" alt="avatar" class="avatar">
                    ...
                    <div id="tabs-1">
                        <div class="container">
                            <div class="container_top">
                                <img class="anh_san_pham" src="../phone_thuan/images/products/capsac1.jpg" alt="san_pham">
                                <div class="review_sp">
                                    <div>
                        ...
                        <div class="container">
                            <div class="container_top">
                                <img class="anh_san_pham" src="../phone_thuan/images/products/cucsac1.jpg" alt="san_pham">
                                <div class="review_sp">
                                    <div>
                        ...
                        <div class="container last">
                            <div class="container_top">
                                <img class="anh_san_pham" src="../phone_thuan/images/products/cuongluc.jpg" alt="san_pham">
                                <div class="review_sp">
                                    <div>
                    ...
                    <div class="bottom">
                        <form action="#logoJCTop" method="dialog">
                            ...
                            <div class="chooseAvatar">
                                <img src="../phone_thuan/images/avatar.jpg" alt="" class="avatar">
                ...
                <div id="tab3">
                    ...
                    <div class="thong-bao-container">
                        <div class="thong_bao_div unread">
                            <img src="../phone_thuan/images/products/cucsac1.jpg" alt="san_pham">
                        ...
                        <div class="thong_bao_div unread">
                            <img src="../phone_thuan/images/products/cuongluc.jpg" alt="san_pham">
                            <div class="thong_bao_content">
                                <p class="thong_bao_head">Giao hàng thành công</p>
                        ...
                        <div class="thong_bao_div unread">
                            <img src="../phone_thuan/images/products/tainghe5.jpg" alt="san_pham">
                            <div class="thong_bao_content">
                        ...
                        <table>
                                ...
                                <td>
                                    <div class="voucher">
                                        <div class="voucherIcon">
                                            <img src="../phone_thuan/images/voucherGiamGia.png" alt="Voucher Giam Gia">
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="voucher">
                                        <div class="voucherIcon">
                                            <img src="../phone_thuan/images/mienpivanchuyen.png" alt="Voucher Giam Gia"
                                                 class="freeship">
                                        </div>
                                        <div class="voucherInfo">
