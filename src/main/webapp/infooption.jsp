...
<%@ page import="vn.edu.hcmuaf.fit.DAO.OptionDAO" %>
...
<%Option option = OptionDAO.getOption(request.getParameter("id"));%>
<body>
        ...
        <div id="rightContainer">
            <div class="right-tab add-new-product add-tab">
                ...
                <div class="right-tab-container" style="position: relative">
                    <form action="/InfoOptionServlet" method="post" enctype="multipart/form-data">
                        ...
                        <table class="add-new-product-table">
                            <tr class="table-row">
                                ...
                                <td class="input-col">
                                    <input
                                            type="text" required value="<%=option.getValue()%>"
                                            name="attribute"
                            ...
                            <tr class="table-row">
                                ...
                                <td class="input-col">
                                    <input
                                            type="number" required value="<%=option.getPrice()%>"
                                            name="unitPrice"
                            ...
                            <tr class="table-row">
                                ...
                                <td class="input-col">
                                    <input
                                            type="number" required value="<%=option.getQuantity()%>"
                                            name="quantity"
                            ...
                            <tr class="table-row">
                                ...
                                <td class="input-col">
                                    ...
                                    >
                                        <option value="-1" class="new-product-status-option" <%=option.getStatus()==-1?"selected":""%>>
                                            Đã xóa
                                        </option>
                                        <option value="0"
                                                class="new-product-status-option"
                                                <%=option.getStatus()==0?"selected":""%>>
                                            Sắp mở bán
                                        </option>
                                        <option value="1" class="new-product-status-option" <%=option.getStatus()==1?"selected":""%>>
                                            Đang bán
                                        </option>
                                        <option value="2" class="new-product-status-option" <%=option.getStatus()==2?"selected":""%>>
                                            Dừng kinh doanh
                                        </option>
                                    </select>
                                </td>
                                ...
                                <td class="input-col">
                                    <main>
                                        <div class="container imageUploadContainer"
                                            ...
                                            <div>
                                                <img src="<%=option.getImg()%>" alt="Ảnh xem trước" id="imagePreview"
                                                     style="width:200px;height: auto;border-radius: 0.3em;"/>
                                            </div>
                                            <div class="imageUpload">
                                                <input type="file" id="imageUploadInput" name="img" accept="image/*" value="<%=option.getImg()%>"/>
                                            </div>
                                        </div>
                                    </main>
                                </td>
