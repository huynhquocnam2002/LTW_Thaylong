...
@WebServlet(name = "InfoVoucherServlet", value = "/InfoVoucherServlet")
public class InfoVoucherServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("infovoucher.jsp").forward(request, response);
    }
