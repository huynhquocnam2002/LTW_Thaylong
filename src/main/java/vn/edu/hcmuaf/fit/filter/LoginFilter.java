...
@WebFilter(filterName = "LoginFilter", urlPatterns = {"/UserServlet","/AnnouncementServlet","/ChangeInfoUserServlet","/VerifyRegisterServlet","/WelcomeAdminServlet","/ChangePassServlet","/PayServlet"})
