...
const list_extend_button = document.querySelectorAll('#admin-content #rightContainer .row-table-end .show-all-type-product')
...
const list_quantity_type_of_product = document.querySelectorAll('#admin-content #rightContainer .row-table-end .quantity-type')
const list_quantity_product_in_tab = document.querySelectorAll('#admin-content #rightContainer .flex-item span.quantity')
...
const quantity_checked_order = document.querySelector('#admin-content #rightContainer .manage-orders .manage-orders-filter-container .quantity')
const list_copy_button = document.querySelectorAll('#admin-content #rightContainer .copy-icon')
...
const list_product_tool_button = document.querySelectorAll('#admin-content #rightContainer .manage-products .tool-button')
const list_order_tool_button = document.querySelectorAll('#admin-content #rightContainer .manage-orders .tool-button')
const search_product_button = document.querySelector('#admin-content #rightContainer .manage-products .input-filter .id-product-filter-div button .search-icon').parentElement
const search_order_button = document.querySelector('#admin-content #rightContainer .manage-orders .input-filter .id-order-filter-div button .search-icon').parentElement
const search_product_input = document.querySelector('#admin-content #rightContainer .manage-products .input-filter .id-product-filter-div .id-product-filter').parentElement
const search_order_input = document.querySelector('#admin-content #rightContainer .manage-orders .input-filter .id-order-filter-div .id-order-filter').parentElement
